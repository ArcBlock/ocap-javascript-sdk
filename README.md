...
> Javascript SDK for OCAP service for Node.js, Browser(ES6+ or ES5) and ReactNative, latest release at 10/15/2018, 9:06:50 AM

## Packages Included

- [@arcblock/ocap-js v0.8.5](./packages/ocap-js)
- [@arcblock/ocap-schema v0.8.3](./packages/ocap-schema)
- [@arcblock/sdk-util v0.8.5](./packages/sdk-util)
