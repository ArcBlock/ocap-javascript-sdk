![ocap-javascript-sdk](https://www.arcblock.io/.netlify/functions/badge/?text=ocap-javascript-sdk)

[![lerna](https://img.shields.io/badge/maintained%20with-lerna-cc00ff.svg)](https://lernajs.io/)

> Javascript SDK for OCAP service for Node.js, Browser(ES6+ or ES5) and ReactNative, latest release at 7/15/2019, 9:16:05 AM

## Packages Included

- [@arcblock/ocap-cli v0.22.0](./packages/ocap-cli)
- [@arcblock/ocap-js v0.22.0](./packages/ocap-js)
- [@arcblock/ocap-schema v0.22.0](./packages/ocap-schema)
- [@arcblock/sdk-util v0.22.0](./packages/sdk-util)
