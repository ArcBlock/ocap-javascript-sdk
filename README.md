...
> Javascript SDK for OCAP service for Node.js, Browser(ES6+ or ES5) and ReactNative, latest release at 1/26/2026, 9:25:12 AM

## Packages Included

- [@arcblock/ocap-js v0.36.2](./packages/ocap-js)
- [@arcblock/ocap-schema v0.36.2](./packages/ocap-schema)
- [@arcblock/sdk-util v0.36.2](./packages/sdk-util)
